        ...
        <div className={`${selectedRoom === 'All Rooms' ? 'lg:col-span-2' : 'lg:col-span-1'} flex-shrink-0`}>
          {selectedRoom === 'All Rooms' ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <div className="w-full h-64 md:h-72 lg:h-80 flex items-center justify-center rounded-xl bg-gradient-to-br from-green-900 to-blue-700 p-6 text-white text-lg font-semibold text-center leading-relaxed shadow-lg">
                <ol className="list-decimal list-inside space-y-2">
                  ...
                  <li>The active devices and energy usage would only change once you toggle the switches (steps 1 & 2)</li>
                </ol>
              </div>
