...
const doYouKnowFacts = ["Did you know? Our ML models detect energy anomalies early to save you money.", "Did you know? AI analyzes your energy spikes and makes tariff optimizations.", "Did you know? Machine learning optimizes your home energy usage in real-time."];

const activityFeed = ["✓ Connected to analytics server", "⚡ Loading your energy data", "🧠 Random Forest model: Training...", "🌲 Running Isolation Forest for Anomaly Detection", "📊 Generating predictions...", "💡 Calculating savings opportunities..."];

const carouselImages = [{url: "https://img.freepik.com/premium-photo/realistic-3d-illustration-modern-bedroom-night-city-view-interior-design-apartment-luxury-home-architecture-bed-decor-urban_1088041-51665.jpg", alt: "1"}, {url: "https://img.freepik.com/free-photo/indoor-design-luxury-resort_23-2150497286.jpg?semt=ais_hybrid&w=740", alt: "2"}, {url: "https://img.freepik.com/premium-photo/modern-bedroom-interior-design-with-forest-view-3d-illustration_1233553-83781.jpg?w=360", alt: "3"}];

const loadingCarouselImages = [{url: "https://illustrarch.com/wp-content/uploads/2024/04/Sustainable_Architectural_Solutions_for_Smart_Homes_8.jpg", alt: "1"}, {url: "https://64.media.tumblr.com/0ded6a5da5aa5db5f5a1764744fa132b/05266ec9d5a051e9-11/s1280x1920/d4a5020ae8cdd7309933e68c5260024a89346551.jpg", alt: "2"}, {url: "https://images.unsplash.com/photo-1514803400321-3ca29fc47334?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHNtYXJ0JTIwaG9tZXxlbnwwfHwwfHx8MA%3D%3D", alt: "3"}, {url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQHoFDkjhWSYwiur6Qt_OuwyMrrJ3h5Lz8Cw&s", alt: "4"}, {url: "https://www.iotworlds.com/wp-content/uploads/2023/01/iotworlds-smart-lighting-system-using-iot.png", alt: "5"}];

function Carousel({ images }) {
 const [index, setIndex] = useState(0);
 useEffect(() => {
   const interval = setInterval(() => setIndex((prev) => (prev + 1) % images.length), 3500);
 ...
 return (
   <div className="relative w-full h-[280px] flex items-center justify-center">
     <img src={images[index].url} alt={images[index].alt} className="w-full h-[280px] object-cover rounded-lg transition-all duration-700" style={{ maxWidth: '100%', maxHeight: '280px' }} />
     <button className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/60 text-white rounded-full p-2 hover:bg-black/80" onClick={prev} aria-label="Previous" style={{ zIndex: 2 }}>←</button>
     <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/60 text-white rounded-full p-2 hover:bg-black/80" onClick={next} aria-label="Next" style={{ zIndex: 2 }}>→</button>
     <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2">
       {images.map((img, i) => <span key={i} className={`w-2 h-2 rounded-full ${i === index ? 'bg-blue-400' : 'bg-gray-500'}`} style={{ display: 'inline-block' }}></span>)}
     </div>
   </div>
 );
}
